...
import com.dubboclub.dk.admin.service.impl.OverrideServiceImpl;
...
public class OverrideController {
    ...
    @RequestMapping("/batch/deletedynamicconfig.htm")
    public @ResponseBody BasicResponse deletedynamicconfig(@RequestParam("ip")String ip,@RequestParam("application")String application){
        BasicResponse response = new BasicResponse();
//        System.out.println("ip is"+ip+"  application is "+application);
        List<Long> ids = overrideService.listByIP(ip,application);
