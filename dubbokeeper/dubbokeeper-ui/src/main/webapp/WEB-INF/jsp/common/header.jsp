...
<head>
    ...
    <link href="${pageContext.request.contextPath}/css/hydraquery.css" rel="stylesheet" type="text/css"/>
    <link href="${pageContext.request.contextPath}/css/jquery.qtip.min.css" rel="stylesheet" type="text/css"/>
    <link href="${pageContext.request.contextPath}/js/libs/datetimepicker/css/datetimepicker.css" rel="stylesheet" media="screen">
