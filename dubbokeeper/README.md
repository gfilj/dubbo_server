...
`git clone ssh://git@gitlab.ws.netease.com:16322/cms/dubbokeeper.git`

>2、编译打包

在刚刚clone下来的文件夹内执行`mvn -Dmaven.test.skip=true clean package install -P lucene assembly:assembly -U`
